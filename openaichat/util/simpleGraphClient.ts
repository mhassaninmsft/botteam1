...
class SimpleGraphClient {
  ...
  async GetPhotoAsync(token: string): Promise<string> {
    let graphPhotoEndpoint =
    ...
    let imageBuffer = (await (response as any)
      .arrayBuffer()
  ...
  private unhandledFetchError(err: Error): void {
    console.error("Unhandled fetch error: ", err);
  }
}

export { SimpleGraphClient };
